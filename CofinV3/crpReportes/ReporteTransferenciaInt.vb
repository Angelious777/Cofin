...
Module ReporteTransferenciaInt

    Public Sub GenerarPDF(frm As frmTransferenciaInt, nombreArchivo As String, titulo As String)
        Try
            ...
            ' Título
            'Dim fuenteTitulo As New Font(Font.FontFamily.HELVETICA, 18, Font.BOLD)
            'Dim parrafoTitulo As New Paragraph(titulo, fuenteTitulo)
            ...
            doc.Add(New Paragraph("Banco Origen: ", fuenteBold))
            doc.Add(New Paragraph(frm.cbxBancoOrigen.SelectedItem.ToString(), fuenteDato))
            doc.Add(New Paragraph(" "))
            doc.Add(New Paragraph("Cuenta Destino: ", fuenteBold))
            doc.Add(New Paragraph(frm.txtCuentaDestino.Text, fuenteDato))
            doc.Add(New Paragraph("Banco Destino: ", fuenteBold))
            doc.Add(New Paragraph(frm.cbxBancoDestino.SelectedItem.ToString(), fuenteDato))
            doc.Add(New Paragraph(" "))
